...
app.get('/', (req, res) => {
    ...
    res.send('Servidor de exámenes activo en Vercel. Abre /index.html para la app.');
});
...
// Get exam by code (public version)
